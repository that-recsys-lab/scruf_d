...
from scruf.choice import ChoiceMechanismFactory, xQuadChoiceMechanism, FARChoiceMechanism, PFARChoiceMechanism
...
# TODO: Note not test cases for the non-binary version of FAR
